...
sys.path.insert(0, str(_root / "libs/external/github/lunar-python-master"))
sys.path.insert(0, str(_root / "libs/external/github/bazi-1-master"))
...
class BaziCalculator:
    ...
    def calculate_complete(self) -> Dict[str, Any]:
        ...
        # Phase 1: 寿星万年历高精度历法
        spec = importlib.util.spec_from_file_location("sxwnl_integration", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/sxwnl_integration.py")
        ...
        # Phase 2: 专业紫微斗数系统
        spec = importlib.util.spec_from_file_location("fortel_ziwei_integration", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/fortel_ziwei_integration.py")
        ...
        # Phase 3: 风水罗盘系统
        spec = importlib.util.spec_from_file_location("mikaboshi_fengshui_integration", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/mikaboshi_fengshui_integration.py")
        ...
        # Phase 4: 天文占星计算
        spec = importlib.util.spec_from_file_location("astro_integration", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/astro_integration.py")
        ...
        # Phase 5: 现代化八字重构
        spec = importlib.util.spec_from_file_location("dantalion_integration", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/dantalion_integration.py")
        ...
        # bazi-1完整五行评分系统
        spec = importlib.util.spec_from_file_location("bazi1_integration", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/bazi1_integration.py")
        ...
        # 完整真太阳时计算
        spec = importlib.util.spec_from_file_location("true_solar_time", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/true_solar_time.py")
        ...
        # 奇门遁甲
        spec = importlib.util.spec_from_file_location("qimen", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/qimen.py")
        ...
        # 紫微斗数 (基础版，与专业版并存)
        spec = importlib.util.spec_from_file_location("ziwei", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/ziwei.py")
        ...
        # 大六壬
        spec = importlib.util.spec_from_file_location("liuren", "/home/lenovo/.projects/fate-engine/services/telegram-service/src/liuren.py")
